  ...
  _getRatio: function (scale) {
    ...
    for (var i = 0; i < scale.len; i++) {
      ...
      if (typeof o == 'object') {
        ...
        scale.innerPaddingTop = scale.innerPaddingTop < strokeWidth ? strokeWidth : scale.innerPaddingTop;
      }
      ...
      if (typeof o == 'object' && o.scattered && scale.scattered) {
        ...
        scale.innerPaddingTop = scale.innerPadding > scale.innerPaddingTop ? scale.innerPadding : scale.innerPaddingTop;
        scale.innerPaddingBottom = scale.innerPaddingTop;
      }
    }
