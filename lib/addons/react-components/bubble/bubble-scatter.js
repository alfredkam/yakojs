...
module.exports = React.createClass({
  ...
  render: function render() {
    ...
    if (ToolTipReactElement) {
      content.push(React.createElement(ToolTipReactElement, {
        content: self._eventData }));
    }

    content.push(React.createElement(Bubble, {
