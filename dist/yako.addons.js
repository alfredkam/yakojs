...
/******/ 	var hotCurrentHash = "1891fc927ce98938ca43";
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _EventsFeedback = __webpack_require__(18);

	var _EventsFeedback2 = _interopRequireDefault(_EventsFeedback);
	...
	var Events = (function () {
	  ...
	  _createClass(Events, [{
	    ...
	    // Sets props
	    value: function setProps(scale, data) {
	      this._props = {
	        scale: scale,
	        data: data
	      };
	    ...
	    value: function _associateTriggers(e, next) {
	      e = e || window.event;
	      var self = this;
	    ...
	    value: function _trigger(eventName, e, props, next) {
	      var self = this;
	      ...
	      if (_EventsFeedback2['default'][scale.componentName]) {
	        properties = _EventsFeedback2['default'][scale.componentName](e, props, eX, eY);
	      } else {
	        _utilsError2['default'].eventFeedback(scale.componentName || '');
	      }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _classesDefault = __webpack_require__(20);
	...
	var _svgPath = __webpack_require__(21);

	var _svgPath2 = _interopRequireDefault(_svgPath);

	var _lineApi = __webpack_require__(22);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _classesArc = __webpack_require__(23);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _arc = __webpack_require__(24);
	...
	var _composer = __webpack_require__(26);

	var _composer2 = _interopRequireDefault(_composer);

	var _draw = __webpack_require__(27);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _bubbleApi = __webpack_require__(28);
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = {
	  ...
	  missingDate: function missingDate(componentName) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _svgArc = __webpack_require__(24);
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports['default'] = {
	  ...
	  getRatioByObject: function getRatioByObject(scale) {
	    ...
	    scale.max[2] = scale.maxRange && scale.maxRange.z ? scale.maxRange.z : scale.max[2];
	  ...
	  getRatioByTimeSeries: function getRatioByTimeSeries(scale) {
	    ...
	    if (autoFit == false) {
	      ...
	      // Date time not provided, it will error out (#40)
